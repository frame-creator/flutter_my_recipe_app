   ...
   Widget _sideScreen() {
     ...
     //   )   
           ...
           Padding(
               ...
               child: ImageIcon(AssetImage("assets/icons/te3.png"), size: 120, color: Colors.red[200])
              ),
           SizedBox(
              height: 5,
           //   child: Text('인기 레시피',
          ...
          onTap: () {
            Navigator.of(context)
              ...
              child: Icon( FontAwesomeIcons.coffee, size: 30.0, color: Colors.red[200]),),
              SizedBox(width: 15),
              SizedBox(
              child: Text('문의하기',
     ...
     /*   Container (
        ...
        children: <Widget>[
          ...
          Row(
            ...
            //  ImageIcon(AssetImage("assets/icons/pot1.png"), size: 40, color: Colors.white),
            Row(children: <Widget> [ 
              Padding(
                padding: EdgeInsets.all(5),
               child: ImageIcon(AssetImage("assets/icons/pot0.png"), size: 40, color: Colors.white)
              ),
              Padding(
              padding: EdgeInsets.all(10) ,
             child: Text('홈 쿠킹 레시피',style: TextStyle(
                            fontFamily: 'Cute', 
                            fontSize: 35.0,
                            color: Colors.white)), ),
            ]),
